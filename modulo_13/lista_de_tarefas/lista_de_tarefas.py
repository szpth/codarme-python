...
class ListaDeTarefas:
    def __init__(self):
        """
        _atributo indica que "_atributo" não deve ser acessado diretamente
        fora dessa classe.
        Vamos criar métodos que retornam esses atributos de acordo com uma
        certa lógica.
        """
        self._tarefas = []
    ...
    def get_tarefas(self, incluir_concluidas=False):
        ...
        Se incluir_concluidas for passado como True, inclui as tarefas
        concluídas.
        """
